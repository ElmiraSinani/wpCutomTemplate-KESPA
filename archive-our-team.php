...
<?php if (have_posts()) : ?>
 ...
 <header class="ct-pageHeader">
    <section class="ct-backgroundContent ct-u-displayTableVertical innerPageBG" data-type="pattern" data-height="200" data-bg-image="<?php bloginfo('template_directory'); ?>/images/LaBoheme_cropped.jpg" data-bg-image-mobile="<?php bloginfo('template_directory'); ?>/images/LaBoheme_cropped.jpg">
<!--     <div class="inner ct-pageHeader--bottomRight">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                <div class="ct-blogItem ct-blogItem--primary">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="ct-blogDescription nesTemplate team">
                                ...
                                <?php 
                                    $showMore = get_field('team_show_more');
